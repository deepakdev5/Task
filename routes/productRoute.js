...
const { initializeDatabase, getAllProducts, getTransactions, getBarChartData, getPieChartData, getCombinedData, getSalesStatistics } = require("../controlers/productContlr")
